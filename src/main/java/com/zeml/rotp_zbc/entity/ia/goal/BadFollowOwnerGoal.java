...
public class BadFollowOwnerGoal extends Goal {
    private final BadCompanyUnitEntity tamable;
    ...
    public BadFollowOwnerGoal(BadCompanyUnitEntity p_i225711_1_, double p_i225711_2_, float p_i225711_4_, float p_i225711_5_, boolean p_i225711_6_) {
    ...
    public void tick() {
        this.multiplier = tamable.getStayClose()?100:1;
        this.tamable.getLookControl().setLookAt(this.owner, 10.0F, (float)this.tamable.getMaxHeadXRot());
        if (--this.timeToRecalcPath <= 0) {
            this.timeToRecalcPath = 10;
            if (!this.tamable.isLeashed() && !this.tamable.isPassenger()) {
                if (this.tamable.distanceToSqr(this.owner) >= 2025.0D/multiplier) {
